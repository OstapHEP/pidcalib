...
requests = [
    ...
    ## real histogram: 
    ( mc18u.chain , ( ReSample ( 'pid_pi1' , 'pi_Dstar2Dpi' , 'MagUp_2018'   , 'MC15TuneV1_ProbNNpi' , 'pt_pion[0]*1000' , 'eta_pion[0]' , hRun2   ) ,
                      ReSample ( 'pid_pi2' , 'pi_Dstar2Dpi' , 'MagUp_2018'   , 'MC15TuneV1_ProbNNpi' , 'pt_pion[1]*1000' , 'eta_pion[1]' , hRun2   ) ) ) , 
]
...
with use_canvas ( 'Sampled PID' , wait = 2 ) : 
    ...
    mc18u.chain.draw ( 'pid_pi1'  , color = 4 )
